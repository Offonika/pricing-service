...
«Умное ценообразование Master Mobile на базе 1С и мониторинга конкурентов».
...
**Роль:**  
Технический архитектор. Отвечает за общую архитектуру сервиса ценообразования, схемы БД, интеграции (1С, парсер конкурентов, 1С, Telegram-бот) и технические решения на уровне системы.
...
- Проработка протоколов обмена с 1С, парсером конкурентов, 1С.
...
- Не менять формат обмена с 1С без отражения этих изменений в документации.
...
**Роль:**  
Инженер по данным / интеграциям. Отвечает за импорт, очистку, нормализацию и хранение данных из внешних источников (1С, парсер конкурентов и др.).

**Основные задачи:**
- Разработка модулей импорта:
- чтение данных напрямую из SQL 1С (Ekama) и сопутствующих выгрузок при необходимости,
