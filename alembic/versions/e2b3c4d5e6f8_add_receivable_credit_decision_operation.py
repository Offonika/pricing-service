...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("contract_organization_ref", sa.String(length=64), nullable=False),
        sa.Column("contract_organization_guid", sa.String(length=36), nullable=False),
        ...
        sa.Column("expected_control_enabled", sa.Boolean(), nullable=False),
        sa.Column("proposed_limit", sa.Numeric(18, 2), nullable=False),
        sa.Column("proposed_depth", sa.Integer(), nullable=False),
        sa.Column("proposed_control_enabled", sa.Boolean(), nullable=False),
        ...
        sa.Column("readback_control_enabled", sa.Boolean(), nullable=True),
        sa.Column(
            "bitrix_sync_pending",
            sa.Boolean(),
            nullable=False,
