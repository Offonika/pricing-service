...
class ReceivableCreditDecisionOperation(Base):
    ...
    contract_guid: Mapped[str] = mapped_column(String(36), nullable=False)
    ...
    contract_organization_ref: Mapped[str] = mapped_column(String(64), nullable=False)
    contract_organization_guid: Mapped[str] = mapped_column(String(36), nullable=False)
    ...
    expected_control_enabled: Mapped[bool] = mapped_column(nullable=False)
    ...
    proposed_control_enabled: Mapped[bool] = mapped_column(nullable=False)
    ...
    readback_control_enabled: Mapped[Optional[bool]] = mapped_column(nullable=True)
