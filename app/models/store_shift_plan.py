...
class StoreShiftPlan(Base):
    __tablename__ = "store_shift_plan"
    __table_args__ = (
        UniqueConstraint("business_key", name="uq_store_shift_plan_business_key"),
        Index("ix_store_shift_plan_shift_date", "shift_date"),
        Index("ix_store_shift_plan_store_shift", "store_ref", "shift_code"),
    )
    ...
    planned_end_at: Mapped[Optional[datetime]] = mapped_column(DateTime, nullable=True)
