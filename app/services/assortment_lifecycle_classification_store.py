...
ASSORTMENT_LIFECYCLE_CLASSIFICATION_TABLE = Table(
    ...
    Column("first_stock_inflow_at", Date, nullable=True),
    Column("last_stock_inflow_at", Date, nullable=True),
        ...
        rows.append(
            {
                ...
                "first_stock_inflow_at": _source_date(source_record, "first_stock_inflow_at"),
                "last_stock_inflow_at": _source_date(source_record, "last_stock_inflow_at"),
