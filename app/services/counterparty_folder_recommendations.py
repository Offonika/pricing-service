...
def _folders_equivalent(
    ...
    if folder_row is None or document_row is None:
        return False
    return _refs_equal(
...
def _build_item(
    ...
    *,
    ...
    if review_reason is None:
        folders_match = _folders_equivalent(folder_row, document_row)
    ...
    return {
        ...
        "recommended_folder_display_name": (
            _folder_display_name(document_row.recommended_folder_name) if document_row else None
        ),
