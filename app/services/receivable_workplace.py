...
def _effective_due_date(
    ...
    *,
    ...
    origin_date = debt_document_date or case.origin_document_date
...
def _build_documents(
    ...
    *,
    ...
    raw_documents = list(open_debt_documents or case.chain_documents or [])
...
def _staff_matches_department(
    ...
    *,
    ...
    staff_refs = expand_receivable_department_refs(
        [staff.department_ref, staff.store_ref],
        names=[staff.department_name, staff.store_name],
    )
    ...
    return any(
        ...
        for value in (staff.department_name, staff.store_name)
    )
