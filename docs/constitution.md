...
Название: «Умное ценообразование Master Mobile на базе 1С и мониторинга конкурентов».
...
- работает в одной логике с 1С (ABC/XYZ, статусы запасов и товаров) и 1С.
...
- **Архитектура**: `docs/architecture.md`  
  - Схемы модулей, БД, интеграций (1С, ZennoPoster, 1С, Telegram-бот).
...
Интеграции:
- **1С** — прямое чтение из базы 1С/Ekama (MSSQL, read-only) с номенклатурой, остатками, закупочными ценами;
