...
| Logistics/Telegram | `TechDesign.LogisticsTelegramMVP.md`, `IntegrationContract.Logistics1C.md`, `IntegrationContract.LogisticsSiteOrders1C.md`, `Onepage.LogisticsTelegramMVP.md`, `specs/logistics-control-contour.md`, `specs/customer-return-carrier-control.md`, `specs/transfer-assistant-readonly-v1.md` |
| Expertise/order flow | `Onepage.ExpertiseCaseMVP.md`, `Onepage.SiteServiceRequestsMVP.md`, `specs/site-service-requests-mvp.md` (каноническая Implementation Spec задачи №3223), `TechDesign.ExpertiseCaseMVP.md`, `IntegrationContract.Expertise1C.md`, `IntegrationContract.CustomerOrderClosureQueue1C.md` (двухэтапная очередь закрытия заказов УТ 10.3), `Runbook.ExpertiseWave1.md`, `order_flow/README.md`, `specs/site-order-fulfillment-control-contour.md`, `specs/site-defect-archive-search.md` |
