...
| Management/BI | `specs/customer-price-type-management-v1.md` (каноническая accepted spec типов цен), `TechDesign.ManagementControlTower.md`, `BI.Receivables.md`, `specs/receivables-smart-process-workflow.md`, `Onepage.ReceivablesWorkProcess.md` (исторический onepager), `specs/executive-management-dashboard-bitrix.md`, `specs/counterparty-folder-recommendations.md`, `specs/ut103-bot-command-file-exchange.md` (включая атомарный `set_credit_terms` задачи №2494), `specs/exchange-counterparty-daily-settlements.md`, `BI.ModelDemand.md`, `receivable_authoritative_evening_runbook.md` |
| Customer account | `specs/customer-settlements-backend-v1.md` (почасовой backend взаиморасчётов, CRM mapping, assertion и rollout gate) |
| Procurement | `specs/assortment-lifecycle-policy.md` (единственный источник формулы и места хранения жизненного статуса), `specs/assortment-status-contour-plan.md` (канонический план и межсистемные границы), `specs/onec-stock-effective-availability.md` (дневное наличие из 1С), `specs/procurement-order-formation-smart-process.md` (технический источник OAuth-приложения и черновика заказа), `specs/ved-akb-import-pilot.md` |
...
| Expertise/order flow | `specs/quality-case-confirmed-defect-rate-v1.md` (канонический контракт подтверждённого брака), `Onepage.ExpertiseCaseMVP.md`, `TechDesign.ExpertiseCaseMVP.md`, `IntegrationContract.Expertise1C.md`, `Runbook.ExpertiseWave1.md`, `order_flow/README.md`, `specs/site-order-fulfillment-control-contour.md`, `specs/site-defect-archive-search.md` |
