...
| Expertise/order flow | `Onepage.ExpertiseCaseMVP.md`, `Onepage.SiteServiceRequestsMVP.md`, `specs/site-service-requests-mvp.md` (каноническая Implementation Spec задачи №3223), `TechDesign.ExpertiseCaseMVP.md`, `IntegrationContract.Expertise1C.md`, `IntegrationContract.OrderAssemblyQueue1C.md` (единая CRM-очередь сборки задачи №46), `Runbook.ExpertiseWave1.md`, `order_flow/README.md`, `specs/site-order-fulfillment-control-contour.md`, `specs/site-defect-archive-search.md` |
