...
| Logistics/Bitrix24 | `Onepage.LogisticsTelegramMVP.md`, `specs/logistics-control-contour.md`, `TechDesign.LogisticsTelegramMVP.md`, `IntegrationContract.Logistics1C.md`, `IntegrationContract.LogisticsSiteOrders1C.md`, `specs/transfer-assistant-readonly-v1.md` |
