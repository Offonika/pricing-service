...
- [x] S2.1 — Импорт товаров и остатков из 1С
...
- [ ] S4.1 — (отложено, считаем в 1С) Добавить продвинутую аналитику по оборачиваемости и ABC/XYZ
...
- [x] S4.12 — Техдизайн матчинга конкурентов с номенклатурой  
  Документ с полями 1С (tovar/ostatki), правилами нормализации SKU/код инфсистемы, ручными оверрайдами, целевой записью в competitor_price.
- [x] S4.13 — Реализовать матчинг FTP-цен конкурентов к товарам 1С
...
- [x] S5.8 — Матчинг Product ↔ PhoneModel для использования спроса в pricing  
  Правила сопоставления бренда/модели из 1С с PhoneModel, ручные правки/логирование нестыковок.
