...
3. Рабочие очереди и фильтры; пользовательское название фильтра `data_check` —
...
- [ ] Реализовать 1С contract v2 для утверждённых одноступенчатых повышений и
  понижений стандартных уровней.
...
- [ ] Связать подтверждение руководителя в витрине с формированием `dry_run`,
  сохранив отдельный шлюз на `apply`.
