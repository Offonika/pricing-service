...
BP-снимок обязан точно совпадать с `source_cutoff_date=31.12.2025`. На самой
базовой дате consumer воспроизводит все исторические компоненты договора, а
после неё использует замороженный входящий капитал вместе с актуальными
операционными статьями. Другую дату нельзя считать актуальной или переносить в
прошлое. Неподтверждённые зарплата, услуги, owner cash control и прочие
