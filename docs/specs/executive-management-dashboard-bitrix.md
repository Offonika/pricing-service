...
выбранного периода. Эти суммы не подменяются нулями при отсутствии отчета и
пока не включаются повторно в операционные расходы ОПУ: сначала требуется
подтвердить, что они не задвоятся с себестоимостью продаж.
