...
оплаты налогов в налоговый расход не входят. Чистая прибыль считается только при
статусе налогового контракта `ready`; незакрытый месяц остаётся `partial`.
...
чистая прибыль / выручка; обе карточки показывают статус источника вместо нуля,
если чистая прибыль ещё не рассчитана.
