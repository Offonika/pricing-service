...
ОСВ использует закрытый начальный снимок на 01.01.2026 и выбранный конечный
снимок. В первой версии нет подтверждённых валовых оборотов регистров УТ 10.3:
