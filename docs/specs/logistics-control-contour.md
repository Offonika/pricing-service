...
# Текущий Пилот На 2026-08-28

- Production работает на immutable release из commit `28480e7`.
- Основной UX — приложение Bitrix24; Telegram и web fallback используют ту же
  state machine.
- Арсений Кештов и Андрей Платонов активны как `admin` без обхода проверок.
