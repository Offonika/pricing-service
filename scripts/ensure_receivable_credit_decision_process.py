...
CUSTOM_FIELD_SPECS = [
    ...
    },
    {
        ...
        "title": "Тех. ref организации договора 1С",
        "type": "string",
        "required": True,
        "edit_in_list": False,
        "searchable": True,
    },
    {
        ...
        "title": "GUID организации договора 1С",
        "type": "string",
        "required": True,
        "edit_in_list": False,
        "searchable": True,
    ...
    {
        "logical_key": "contract_organization_code",
        "title": "Код организации договора 1С",
        "type": "string",
        "required": True,
        "edit_in_list": False,
        "searchable": True,
    ...
    {
        "logical_key": "contract_organization_name",
        "title": "Организация договора",
        "type": "string",
        "required": True,
        "edit_in_list": False,
        "searchable": True,
    ...
    {
        "logical_key": "current_debt_control_enabled",
        "title": "Текущий контроль суммы задолженности",
        "type": "boolean",
        "required": True,
        "edit_in_list": True,
        "searchable": False,
    ...
    {
        "logical_key": "proposed_debt_control_enabled",
        "title": "Предлагаемый контроль суммы задолженности",
        "type": "boolean",
        "required": True,
        "edit_in_list": True,
        "searchable": False,
    ...
    {
        "logical_key": "readback_debt_control_enabled",
        "title": "Фактический контроль суммы по readback",
        "type": "boolean",
        "required": False,
        "edit_in_list": False,
        "searchable": False,
