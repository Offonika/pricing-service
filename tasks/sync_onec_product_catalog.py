"""Синхронизация номенклатуры из 1С УТ 10.3 в таблицу ``product``."""
...
def import_onec_products(engine_app, engine_onec) -> dict:
    ...
    session_factory = sessionmaker(bind=engine_app, class_=Session, expire_on_commit=False)
