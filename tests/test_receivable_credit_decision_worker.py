...
MAPPING = {
    ...
    "fields": {
        ...
        "current_control_enabled": "currentControlEnabled",
        "proposed_limit": "proposedLimit",
        "proposed_depth": "proposedDepth",
        "proposed_control_enabled": "proposedControlEnabled",
        "reason": "reason",
        ...
        "readback_control_enabled": "readbackControlEnabled",
    },
}
...
def _item() -> dict[str, object]:
    return {
        ...
        "contractRef": "0X8FDA0025901E48EE11ED222EA7D9B22F",
        "contractGuid": "a7d9b22f-222e-11ed-8fda-0025901e48ee",
        "contractCode": "РБ0058149",
        "contractName": "Основной договор1",
        "contractOrganizationRef": "0X8FDA0025901E48EE11ED222EA7D9B230",
        "contractOrganizationGuid": "a7d9b230-222e-11ed-8fda-0025901e48ee",
        "currentLimit": "100000.00",
        "currentDepth": "7",
        "currentControlEnabled": True,
        "proposedLimit": "150000.00",
        "proposedDepth": "14",
        "proposedControlEnabled": True,
...
def _write_result(
    ...
    *,
    ...
    readback_control_enabled: bool = True,
) -> Path:
    message_id = {
    ...
    readback = (
      ...
      <ReadbackControlEnabled>{str(readback_control_enabled).lower()}</ReadbackControlEnabled>"""
    )
    path.write_text(
