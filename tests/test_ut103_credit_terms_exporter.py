...
def test_build_credit_terms_xml_keeps_atomic_pair_and_windows_encoding() -> None:
    ...
    assert root.findtext("Commands/Command/ContractCode") == "РБ0058149"
    assert root.findtext("Commands/Command/ExpectedControlEnabled") == "true"
    assert root.findtext("Commands/Command/NewControlEnabled") == "true"
...
<ExchangeResult>
  ...
  <CommandResults>
    <CommandResult>
      ...
      <ContractRef>0X8FDA0025901E48EE11ED222EA7D9B22F</ContractRef>
      <ContractGuid>a7d9b22f-222e-11ed-8fda-0025901e48ee</ContractGuid>
      ...
      <ReadbackControlEnabled>true</ReadbackControlEnabled>
    </CommandResult>
  </CommandResults>
</ExchangeResult>""",
